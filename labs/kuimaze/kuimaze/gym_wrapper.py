...
class MazeEnv(gym.Env):
    ...
    def __init__(self, informed, gym_compatible, deter, map_image_dir=None, grad=(0, 0)):
        '''
        ...
        if grad is None:
            ...
            self._grad = grad
        self._problem = kuimaze.Maze(self.MAP, self._grad)
...
class HardMaze(MazeEnv):
    ...
    def __init__(self, map_image=None, grad=(0, 0), probs=None):
        if probs is not None:
            super(HardMaze, self).__init__(False, True, False, map_image, grad)
